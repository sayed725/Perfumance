...
const ResponsiveFooter = () => {
    return (
        <footer className="bg-white  rounded-xl w-full py-6 md:py-9 lg:container mx-auto">
            <div className="flex justify-between gap-[30px] flex-wrap w-full">
                ...
                <div>
                    ...
                    <div className="flex text-black flex-col gap-[10px]">
                        <p className="text-[0.9rem] text-[#424242] hover:text-[#3B9DF8] cursor-pointer transition-all duration-200">Dribbble</p>
                ...
                <div>
                    <h3 className="text-[1.2rem] font-semibold text-[#424242] mb-2">Join a
                        Newsletter</h3>
