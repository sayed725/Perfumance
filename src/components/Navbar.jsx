...
const ResponsiveNavbar = () => {
    ...
    return (
       <div>
         <nav
            className="flex items-center justify-between w-full relative py-2 lg:container mx-auto">

            {/* logo */}
            <img src="/perfumance_logo_black.webp" alt="logo" className="w-[200px]"/>
            ...
            <div className="flex items-center gap-[15px]">
                <div className="flex items-center gap-[10px] cursor-pointer relative"
                    ...
                    <h1 className="text-[1rem] font-[400] text-gray-600 sm:block hidden">Mark</h1>
